export default function Settings({ idName, label="button", description="does something useful" }) {
    return (
        <div className="flex justify-between align-center w-full">
            <div className="text-glow font-french-canon text-xxxs">{description}</div>
            <div className="bg-border rounded-1/2 w-16 h-8 relative">
                <input type="button" className="sr-only" id={idName} />
                <label htmlFor={idName} className="absolute inset-0 cursor-pointer"></label>
